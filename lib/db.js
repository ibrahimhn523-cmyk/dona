...
// طبقة البيانات: كل دالة تعمل على صفوف المستخدم الحالي فقط (RLS تضمن ذلك).
// user_id يُملأ تلقائياً من الجلسة.
